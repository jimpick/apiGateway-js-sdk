...
The generated SDK depends on third-party libraries. Inclde all of the scripts in yoru webpage
...
```
var params = {
    //This is where any modeled request params go. The key is the parameter named as defined in the API
    param0: '',
    param1: ''
};
var body = {
